...
class UserActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        client = BaseApplication.instance.basicClient.chatClient
    ...
    private fun setListener() {
        client?.setListener(object : ChatClientListener {
            ...
            override fun onError(error: ErrorInfo) {
                BaseApplication.instance.showError("Error listening for userInfoChange", error)
            }
            ...
            override fun onUserUpdated(user: User, reason: User.UpdateReason) {
                ...
                BaseApplication.instance.showToast("Update successful for user attributes")
            }
            ...
            override fun onTokenExpired() {
                BaseApplication.instance.basicClient.onTokenExpired()
            }

            override fun onTokenAboutToExpire() {
                BaseApplication.instance.basicClient.onTokenAboutToExpire()
            }
        })
    }
