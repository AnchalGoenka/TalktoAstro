...
import tta.destinigo.talktoastro.models.Media
import java.io.File
        ...
        GlobalScope.launch(coroutineContext) {
            ...
            try {
                if (cursor.moveToFirst()) {
                    ...
                    BaseApplication.instance.basicClient.chatClient?.channels?.getChannel(channel.sid, ChatCallbackListener<Channel> {
